package com.bk.spring.proto.bkprotobuf;
...
import com.bk.spring.proto.bkprotobuf.models.Student;
import com.bk.spring.proto.bkprotobuf.models.Student.PhoneNumber;
import com.bk.spring.proto.bkprotobuf.models.Student.PhoneType;
...
public class ProtocolBufferDemoApplication {

	public static void main(String[] args) {
		SpringApplication.run(ProtocolBufferDemoApplication.class, args);
	}
    ...
    public CourseRepository createTestCourses() {
        Map<Integer, com.bk.spring.proto.bkprotobuf.models.Course> courses = new HashMap<>();
